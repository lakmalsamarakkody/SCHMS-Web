...
-- Date: Thu, 02 Jan 2020 16:58:52 +0530
...
-- Dumped table `staff_has_subject` with 13 row(s)
--
...
-- Dumped table `student_has_parent` with 7 row(s)
--
...
-- Dumped table `coach` with 2 row(s)
--
...
-- Dumped table `student_health` with 5 row(s)
--
...
-- Dumped table `student_has_sport` with 5 row(s)
--
...
-- Dumped table `exam_type` with 6 row(s)
--
...
-- Dumped table `exam_grade_has_schedule` with 2 row(s)
--
...
-- Dumped table `student_attendance` with 32 row(s)
--
...
-- Dumped table `parent` with 10 row(s)
--
...
SET autocommit=0;
INSERT INTO `student_has_exam_schedule` VALUES (25,64,77,'85','2019-12-08 13:52:12','2019-12-12 07:10:48',NULL),(27,64,78,NULL,'2019-12-08 13:54:12','2019-12-08 13:54:12',NULL),(28,67,77,NULL,'2019-12-27 00:00:00','2019-12-27 00:00:00',NULL);
/*!40000 ALTER TABLE `student_has_exam_schedule` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `student_has_exam_schedule` with 3 row(s)
--
...
-- Dumped table `message` with 5 row(s)
--
...
-- Dumped table `student_has_sport_achievement` with 0 row(s)
--
...
-- Dumped table `staff_attendance` with 56 row(s)
--
...
-- Dumped table `grade` with 12 row(s)
--
...
-- Dumped table `report` with 6 row(s)
--
...
-- Dumped table `user_role` with 7 row(s)
--
...
-- Dumped table `exam_has_grade` with 1 row(s)
--
...
-- Dumped table `exam` with 2 row(s)
--
...
-- Dump completed on: Thu, 02 Jan 2020 16:58:52 +0530
