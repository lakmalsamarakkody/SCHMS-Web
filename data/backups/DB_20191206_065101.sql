...
-- Date: Fri, 06 Dec 2019 06:51:01 +0530
...
SET autocommit=0;
INSERT INTO `backup` VALUES (2,'DB_20191202_035747.sql','Initial','2019-12-02 03:57:47',76,'2019-12-02 03:57:47','2019-12-02 03:57:47',NULL);
...
-- Dumped table `student_has_parent` with 9 row(s)
--
...
-- Dumped table `subject` with 11 row(s)
--
...
-- Dumped table `exam_grade_has_schedule` with 9 row(s)
--
...
-- Dumped table `student` with 6 row(s)
--
...
-- Dumped table `staff_type` with 8 row(s)
--
...
-- Dumped table `coach_has_sport` with 3 row(s)
--
...
-- Dumped table `student_has_class` with 6 row(s)
--
...
-- Dumped table `student_has_exam_schedule` with 9 row(s)
--
...
SET autocommit=0;
INSERT INTO `class` VALUES (15,1,7,'A','2019-09-23 01:37:15','2019-12-04 19:13:59',NULL),(16,3,1,'A','2019-09-23 01:40:39','2019-12-04 18:14:37',NULL),(17,5,NULL,'A','2019-09-23 05:12:49','2019-09-23 05:12:49',NULL),(18,4,NULL,'A','2019-09-23 05:15:05','2019-09-23 05:15:05',NULL),(21,6,NULL,'A','2019-10-01 19:17:17','2019-10-01 19:17:17',NULL),(22,6,NULL,'B','2019-10-01 19:51:15','2019-10-01 19:51:15',NULL),(33,1,NULL,'B','2019-12-01 14:17:15','2019-12-01 14:17:15',NULL),(34,7,NULL,'A','2019-12-01 14:17:41','2019-12-01 14:17:41',NULL),(35,2,NULL,'A','2019-12-01 14:21:26','2019-12-01 14:21:26',NULL),(36,2,NULL,'B','2019-12-01 14:21:35','2019-12-01 14:21:35',NULL),(37,3,NULL,'B','2019-12-01 14:21:43','2019-12-01 14:21:43',NULL),(38,4,NULL,'B','2019-12-01 14:28:52','2019-12-01 14:28:52',NULL),(39,5,NULL,'B','2019-12-01 14:57:16','2019-12-01 14:57:16',NULL),(40,7,NULL,'B','2019-12-01 14:57:44','2019-12-01 14:57:44',NULL),(41,8,NULL,'A','2019-12-01 14:58:03','2019-12-01 14:58:03',NULL),(42,8,NULL,'B','2019-12-01 14:58:26','2019-12-01 14:58:26',NULL),(43,9,NULL,'A','2019-12-01 14:58:35','2019-12-01 14:58:35',NULL),(44,9,NULL,'B','2019-12-01 14:58:42','2019-12-01 14:58:42',NULL),(47,11,NULL,'B','2019-12-01 14:59:14','2019-12-04 17:56:18',NULL);
/*!40000 ALTER TABLE `class` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `class` with 19 row(s)
--
...
SET autocommit=0;
INSERT INTO `grade` VALUES (1,1,'2019-09-16 00:00:00','2019-09-16 00:00:00',NULL),(2,2,'2019-12-01 00:00:00','2019-12-01 00:00:00',NULL),(3,3,'2019-09-21 02:07:46','2019-09-21 02:07:46',NULL),(4,4,'2019-09-21 03:53:16','2019-09-21 03:53:16',NULL),(5,5,'2019-09-21 23:49:46','2019-09-21 23:49:46',NULL),(6,6,'2019-09-28 16:11:22','2019-09-28 16:11:22',NULL),(7,7,'2019-12-01 14:17:28','2019-12-01 14:17:28',NULL),(8,8,'2019-12-01 14:20:50','2019-12-01 14:20:50',NULL),(9,9,'2019-12-01 14:20:55','2019-12-01 14:20:55',NULL),(11,11,'2019-12-01 14:21:05','2019-12-01 14:21:05',NULL);
/*!40000 ALTER TABLE `grade` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `grade` with 10 row(s)
--
...
SET autocommit=0;
INSERT INTO `exam_has_grade` VALUES (39,10,1,'2019-10-01 20:15:16','2019-10-01 20:15:16',NULL),(40,10,6,'2019-10-01 20:15:47','2019-10-01 20:15:47',NULL),(42,14,3,'2019-10-03 06:09:18','2019-10-03 06:09:18',NULL),(44,10,3,'2019-10-07 02:39:39','2019-10-07 02:39:39',NULL),(45,13,3,'2019-10-07 02:56:57','2019-10-07 02:56:57',NULL),(46,10,5,'2019-11-24 03:19:32','2019-11-24 03:19:32',NULL),(48,20,11,'2019-12-04 04:21:43','2019-12-04 04:21:43',NULL);
/*!40000 ALTER TABLE `exam_has_grade` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `exam_has_grade` with 7 row(s)
--
...
SET autocommit=0;
INSERT INTO `exam` VALUES (10,1,'2020',NULL,NULL,'2019-09-29 03:35:16','2019-09-29 03:35:16',NULL),(13,4,'2019','test','test','2019-10-03 05:51:55','2019-10-03 05:51:55',NULL),(14,5,'2020','test','test','2019-10-03 06:02:04','2019-10-03 06:02:04',NULL),(20,7,'2019',NULL,NULL,'2019-12-04 04:21:20','2019-12-04 04:21:20',NULL);
/*!40000 ALTER TABLE `exam` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `exam` with 4 row(s)
--
...
-- Dump completed on: Fri, 06 Dec 2019 06:51:01 +0530
