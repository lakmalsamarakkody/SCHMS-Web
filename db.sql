...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_ibfk_3` FOREIGN KEY (`class_id`) REFERENCES `student_has_class` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-12-12  1:23:03
