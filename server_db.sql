...
--
-- Host: localhost
-- Generation Time: Dec 29, 2019 at 11:43 AM
...
(1, NULL, 'staff', 'admin', '$2y$10$M6vZ2RswJ/OthfJMTRQoruycfUr.ehD4kq5G8rC08FfVg3eGZUHTK', 'Default', 1, 'Active', '2019-02-20 00:00:00', '2019-02-20 00:00:00', NULL);
...
ALTER TABLE `user`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `stu_staff_parent_id` (`ref_id`,`role_id`),
