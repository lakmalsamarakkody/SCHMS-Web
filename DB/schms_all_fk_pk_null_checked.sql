...
--
-- Host: localhost
-- Generation Time: Aug 11, 2019 at 12:04 AM
...
--
-- AUTO_INCREMENT for table `student_sport_achievement`
--
ALTER TABLE `student_sport_achievement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `coach_has_sport`
  ADD CONSTRAINT `coach_has_sport_ibfk_1` FOREIGN KEY (`coach_id`) REFERENCES `coach` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `exam_schedule`
  ADD CONSTRAINT `exam_schedule_ibfk_1` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `exam_schedule_ibfk_2` FOREIGN KEY (`grade_id`) REFERENCES `grade` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `exam_schedule_ibfk_3` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `parent`
  ...
  ADD CONSTRAINT `parent_ibfk_1` FOREIGN KEY (`religion_id`) REFERENCES `religion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `staff_has_subject`
  ADD CONSTRAINT `staff_has_subject_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `student_class`
  ADD CONSTRAINT `student_class_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `student_class_ibfk_2` FOREIGN KEY (`stu_id`) REFERENCES `student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `student_has_subject`
  ADD CONSTRAINT `student_has_subject_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `student_sport_achievement`
  ADD CONSTRAINT `student_sport_achievement_ibfk_1` FOREIGN KEY (`stu_sport_id`) REFERENCES `student_has_sport` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user_role_has_permission`
  ADD CONSTRAINT `user_role_has_permission_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `user_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_role_has_permission_ibfk_2` FOREIGN KEY (`permission_id`) REFERENCES `user_role_permission` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
